...
namespace Posthuman.Services.Tests
{
    ...
    public class TodoItemsCyclesServiceTests
    {
        ...
        {
            new TestData(RepetitionPeriod.Weekly, new DateTime(2021, 5, 15), null, true),
            new TestData(RepetitionPeriod.Weekly, new DateTime(2021, 5, 15), new DateTime(2021, 5, 16), false),
            new TestData(RepetitionPeriod.Weekly, new DateTime(2021, 5, 15), new DateTime(2021, 5, 20), false),
            new TestData(RepetitionPeriod.Weekly, new DateTime(2021, 5, 15), new DateTime(2021, 6, 2), false, true),
            new TestData(RepetitionPeriod.Weekly, new DateTime(2021, 5, 15), new DateTime(2021, 5, 10), false)
        };
