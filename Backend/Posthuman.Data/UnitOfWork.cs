...
namespace Posthuman.Data
{
    ...
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(PosthumanContext context)
        {
            ...
            habitsRepository            = habitsRepository          ?? new HabitsRepository(context);
        ...
        public IHabitsRepository Habits                     => habitsRepository             = habitsRepository          ?? new HabitsRepository(context);
